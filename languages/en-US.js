...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_ESCAPEROPE_EXTENDED: builder.display('escaperope', { extendedHelp: '**Skyra** used **Escape Rope**.' }),
			...
			COMMAND_CASE_EXTENDED: builder.display('case', { extendedHelp: `` }),
			...
			COMMAND_BACKUP_EXTENDED: builder.display('backup', { extendedHelp: `The backup command force-starts the backup task which runs twice a week.` }),
			...
			COMMAND_EXEC_EXTENDED: builder.display('exec', { extendedHelp: `You better not know about this.` }),
			...
			COMMAND_SETAVATAR_EXTENDED: builder.display('setAvatar', { extendedHelp: `This command changes Skyra's avatar. You can send a URL or upload an image attachment to the channel.` }),
			...
			COMMAND_ECHO_EXTENDED: builder.display('echo', { extendedHelp: `This should be very obvious...` }),
			...
			COMMAND_STATS_EXTENDED: builder.display('exec', { extendedHelp: `This should be very obvious...` }),
